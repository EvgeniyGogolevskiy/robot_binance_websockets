        ...
        async with websockets.connect(url) as client:
            while True:
                while not position:
                    ...
                    if average_volume*3 < float(data['k']['q']) and 0.4 < now_high_low < 2.5 and float(data['k']['c']) < MA18*(1 - (now_high_low+data_klines['average_diff']) * 0.011) and float(data['k']['c']) < MA9*(1 - now_high_low * 0.011) and 0.1 < now_vol_diff < 0.7:
